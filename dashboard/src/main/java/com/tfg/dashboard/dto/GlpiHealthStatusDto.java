...
public class GlpiHealthStatusDto {

    private int percentage;
    private String color;
    private List<GlpiIndicatorStatusDto> indicators;
    ...
    public List<GlpiIndicatorStatusDto> getIndicators() {
        return indicators;
    }
    ...
    public void setIndicators(List<GlpiIndicatorStatusDto> indicators) {
