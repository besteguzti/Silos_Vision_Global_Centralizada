-- Escenario 07: incidencia combinada Aruba + Citrix.
--
-- Objetivo:
-- - Simular 90 dias historicos.
-- - Mostrar una degradacion progresiva de Aruba.
-- - Mostrar despues una degradacion de Citrix asociada a Delivery Controllers y sesiones.
-- - Mantener Microsoft 365 correcto.
-- - Generar presion GLPI por tickets Aruba y Citrix.
-- - Dejar el ultimo dia como estado actual con Aruba y Citrix degradados.
--
-- Recomendacion:
-- Ejecutar antes:
...
SELECT
    ...
    -- Aruba: primero estable, luego degradacion progresiva.
    CASE
        WHEN base.day_index <= 34 THEN 3 + MOD(base.day_index, 3)
        WHEN base.day_index <= 54 THEN 20 + ((base.day_index - 35) * 2) + MOD(base.day_index, 4)
        WHEN base.day_index <= 74 THEN 55 + MOD(base.day_index, 8)
        ELSE 70 + MOD(base.day_index, 9)
    END AS aruba_affectation,

    CASE
        WHEN base.day_index <= 34 THEN 120 + MOD(base.day_index, 8)
        WHEN base.day_index <= 54 THEN 115 - ((base.day_index - 35) * 3) + MOD(base.day_index, 5)
        WHEN base.day_index <= 74 THEN 65 - MOD(base.day_index, 12)
        ELSE 38 - MOD(base.day_index, 8)
    END AS aruba_wifi_clients,

    CASE
        WHEN base.day_index <= 34 THEN 8 + MOD(base.day_index, 3)
        WHEN base.day_index <= 54 THEN 18 + ((base.day_index - 35) * 2) + MOD(base.day_index, 5)
        WHEN base.day_index <= 74 THEN 58 + MOD(base.day_index, 10)
        ELSE 82 + MOD(base.day_index, 12)
    END AS aruba_open_tickets,

    CASE
        WHEN base.day_index <= 34 THEN 0
        WHEN base.day_index <= 54 THEN 1 + MOD(base.day_index, 2)
    ...
    CASE
        WHEN base.day_index <= 34 THEN 0
        WHEN base.day_index <= 54 THEN 1
        WHEN base.day_index <= 74 THEN 2
        ELSE 3
    END AS aruba_inactive_aps,

    CASE
        WHEN base.day_index <= 54 THEN 0
        WHEN base.day_index <= 74 THEN 1
        ELSE 2
    END AS aruba_down_switches,

    -- Citrix: estable al principio, empieza a degradarse despues de Aruba.
    CASE
        WHEN base.day_index <= 54 THEN 4
        WHEN base.day_index <= 64 THEN 3
        WHEN base.day_index <= 69 THEN 2
        WHEN base.day_index <= 74 THEN 1
        ELSE 0
    END AS citrix_available_delivery_controllers,

    CASE
        WHEN base.day_index <= 34 THEN 180 + MOD(base.day_index, 12)
        WHEN base.day_index <= 54 THEN 160 - ((base.day_index - 35) * 2) + MOD(base.day_index, 4)
        WHEN base.day_index <= 74 THEN 120 - ((base.day_index - 55) * 4) + MOD(base.day_index, 5)
        ELSE 0
    END AS citrix_active_sessions,

    CASE
        WHEN base.day_index <= 54 THEN MOD(base.day_index, 3)
        WHEN base.day_index <= 74 THEN 18 + ((base.day_index - 55) * 2) + MOD(base.day_index, 6)
        ELSE 65 + MOD(base.day_index, 12)
    END AS citrix_failed_logons,

    CASE
        WHEN base.day_index <= 34 THEN 10 + MOD(base.day_index, 4)
        WHEN base.day_index <= 54 THEN 14 + MOD(base.day_index, 6)
        WHEN base.day_index <= 74 THEN 35 + ((base.day_index - 55) * 2) + MOD(base.day_index, 6)
        ELSE 78 + MOD(base.day_index, 10)
    END AS citrix_open_tickets,

    CASE
        WHEN base.day_index <= 34 THEN 3 + MOD(base.day_index, 3)
        WHEN base.day_index <= 54 THEN 12 + MOD(base.day_index, 6)
        WHEN base.day_index <= 74 THEN 42 + (base.day_index - 55)
        ELSE 72 + MOD(base.day_index, 10)
    END AS citrix_affectation,

    -- Microsoft 365 se mantiene correcto. Puede bajar algo la actividad, pero no es causa principal.
    CASE
        WHEN base.day_index <= 34 THEN 1200 + MOD(base.day_index, 50)
        WHEN base.day_index <= 54 THEN 1160 - ((base.day_index - 35) * 3) + MOD(base.day_index, 10)
        WHEN base.day_index <= 74 THEN 1080 - ((base.day_index - 55) * 4) + MOD(base.day_index, 10)
        ELSE 980 - MOD(base.day_index, 20)
    ...
    -- GLPI: suben tickets por Aruba y Citrix.
    CASE
        WHEN base.day_index <= 34 THEN 6 + MOD(base.day_index, 4)
        WHEN base.day_index <= 54 THEN 28 + (base.day_index - 35)
        WHEN base.day_index <= 74 THEN 55 + (base.day_index - 55)
        ELSE 78 + MOD(base.day_index, 14)
    END AS glpi_operational_pressure,

    CASE
        WHEN base.day_index <= 34 THEN 0
        WHEN base.day_index <= 54 THEN 2 + MOD(base.day_index, 3)
        WHEN base.day_index <= 74 THEN 7 + MOD(base.day_index, 5)
        ELSE 14 + MOD(base.day_index, 5)
    END AS critical_open_tickets,

    CASE
        WHEN base.day_index <= 34 THEN 0
        WHEN base.day_index <= 54 THEN 4 + MOD(base.day_index, 4)
        WHEN base.day_index <= 74 THEN 10 + MOD(base.day_index, 5)
        ELSE 18 + MOD(base.day_index, 7)
    END AS sla_breached_tickets,

    CASE
        WHEN base.day_index <= 34 THEN 6
        WHEN base.day_index <= 54 THEN 12
        WHEN base.day_index <= 74 THEN 18
        ELSE 24
    END AS average_resolution_hours,

    CASE
        WHEN base.day_index <= 34 THEN 22 + MOD(base.day_index, 5)
        WHEN base.day_index <= 54 THEN 38 + MOD(base.day_index, 8)
        WHEN base.day_index <= 74 THEN 52 + MOD(base.day_index, 10)
        ELSE 64 + MOD(base.day_index, 12)
    END AS created_today,

    CASE
        WHEN base.day_index <= 34 THEN 22 + MOD(base.day_index, 5)
        WHEN base.day_index <= 54 THEN 20 + MOD(base.day_index, 5)
        WHEN base.day_index <= 74 THEN 17 + MOD(base.day_index, 5)
        ELSE 14 + MOD(base.day_index, 4)
    END AS closed_today,

    CASE
        WHEN base.day_index <= 34 THEN 120 + MOD(base.day_index, 8)
        WHEN base.day_index <= 54 THEN 190 + MOD(base.day_index, 14)
        WHEN base.day_index <= 74 THEN 260 + MOD(base.day_index, 18)
        ELSE 340 + MOD(base.day_index, 20)
    END AS created_this_week,

    CASE
        WHEN base.day_index <= 34 THEN 120 + MOD(base.day_index, 8)
        WHEN base.day_index <= 54 THEN 105 + MOD(base.day_index, 10)
        WHEN base.day_index <= 74 THEN 90 + MOD(base.day_index, 8)
        ELSE 70 + MOD(base.day_index, 8)
    END AS closed_this_week,

    -- Degradacion tecnica combinada.
    CASE
        WHEN base.day_index <= 34 THEN 5 + MOD(base.day_index, 3)
        WHEN base.day_index <= 54 THEN 25 + (base.day_index - 35)
        WHEN base.day_index <= 74 THEN 55 + (base.day_index - 55)
        ELSE 78 + MOD(base.day_index, 12)
    END AS technical_degradation,

    -- Impacto en usuarios por red + Citrix.
    CASE
        WHEN base.day_index <= 34 THEN 3 + MOD(base.day_index, 3)
        WHEN base.day_index <= 54 THEN 22 + (base.day_index - 35)
        WHEN base.day_index <= 74 THEN 50 + (base.day_index - 55)
        ELSE 82 + MOD(base.day_index, 10)
    END AS user_impact,

    -- Criticidad global: más alta porque afecta Aruba y Citrix.
    CASE
        WHEN base.day_index <= 34 THEN 5 + MOD(base.day_index, 3)
        WHEN base.day_index <= 54 THEN 30 + (base.day_index - 35)
        WHEN base.day_index <= 74 THEN 55 + (base.day_index - 55)
        ELSE 75 + MOD(base.day_index, 12)
    END AS global_criticality,

    CASE
        WHEN base.day_index <= 34 THEN 0
        WHEN base.day_index <= 54 THEN 25
        WHEN base.day_index <= 74 THEN 50
        ELSE 70
    END AS affected_services_percent,

    CASE
        WHEN base.day_index <= 34 THEN 0
        WHEN base.day_index <= 54 THEN 12 + MOD(base.day_index, 5)
        WHEN base.day_index <= 74 THEN 32 + MOD(base.day_index, 7)
        ELSE 62 + MOD(base.day_index, 10)
    END AS sla_risk
...
SELECT
    ...
    4,
    CASE
        WHEN day_index <= 54 THEN MOD(day_index, 3)
        WHEN day_index <= 74 THEN 8 + MOD(day_index, 5)
        ELSE 20 + MOD(day_index, 8)
    END,
    CASE
        WHEN day_index <= 54 THEN 10 + MOD(day_index, 6)
        WHEN day_index <= 74 THEN 40 + MOD(day_index, 20)
        ELSE 78 + MOD(day_index, 16)
    END,
    CASE
        WHEN day_index <= 54 THEN 30 + MOD(day_index, 12)
        WHEN day_index <= 74 THEN 55 + MOD(day_index, 20)
        ELSE 0
    END,
...
-- GLPI historico con tickets Aruba + Citrix.
...
-- Estado operativo actual Aruba: degradado.
INSERT INTO `access_points` (
    ...
    ('TFG-AP-01', 'Down', '10.10.10.11', '80.10.10.11', 'TFG-AP-0001', 'Sede TFG', '10.6.0.0', '00:11:22:33:44:01', 'TFG-SWARM', NOW() - INTERVAL 120 DAY, NOW() - INTERVAL 40 DAY),
    ('TFG-AP-02', 'Down', '10.10.10.12', '80.10.10.12', 'TFG-AP-0002', 'Sede TFG', '10.6.0.0', '00:11:22:33:44:02', 'TFG-SWARM', NOW() - INTERVAL 120 DAY, NOW() - INTERVAL 35 DAY),
    ('TFG-AP-03', 'Down', '10.10.10.13', '80.10.10.13', 'TFG-AP-0003', 'Sede TFG', '10.6.0.0', '00:11:22:33:44:03', 'TFG-SWARM', NOW() - INTERVAL 120 DAY, NOW() - INTERVAL 30 DAY),
    ('TFG-AP-04', 'Down', '10.10.10.14', '80.10.10.14', 'TFG-AP-0004', 'Sede TFG', '10.6.0.0', '00:11:22:33:44:04', 'TFG-SWARM', NOW() - INTERVAL 120 DAY, NOW() - INTERVAL 25 DAY),
...
INSERT INTO `aruba_switches` (
    ...
    ('TFG-SW-0001', '00:AA:BB:CC:DD:01', 'TFG-SW-01', 'Aruba 2930F', 'Down', FALSE, 'Down', NOW() - INTERVAL 120 DAY, NOW() - INTERVAL 2 DAY),
    ('TFG-SW-0002', '00:AA:BB:CC:DD:02', 'TFG-SW-02', 'Aruba 2930F', 'Down', FALSE, 'Down', NOW() - INTERVAL 120 DAY, NOW() - INTERVAL 2 DAY),
...
INSERT INTO `aruba_switch_client_usage` (
    ...
    ('TFG-SW-0001', 'TFG-SW-01', '00:AA:BB:CC:DD:01', 'Down', 8, NOW()),
    ('TFG-SW-0002', 'TFG-SW-02', '00:AA:BB:CC:DD:02', 'Down', 8, NOW()),
